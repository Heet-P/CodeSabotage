import { Lobby, Player, GameSettings } from '../types';
...
export class LobbyManager {
    ...
    public createLobby(hostId: string, hostUsername: string): Lobby {
    ...
    public joinLobby(lobbyId: string, playerId: string, username: string): Lobby {
        ...
        if (lobby.players.length >= lobby.settings.maxPlayers) throw new Error('Lobby is full');
